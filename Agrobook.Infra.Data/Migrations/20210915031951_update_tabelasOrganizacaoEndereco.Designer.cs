...
namespace Agrobook.Infra.Data.Migrations
{
    ...
    [Migration("20210915031951_update_tabelasOrganizacaoEndereco")]
    partial class update_tabelasOrganizacaoEndereco
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Parceiro.ContasBancarias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.PatrimonioGroup.Imoveis", b =>
                {
                    ...
                    b.Property<string>("UnidadeMedidaArea")
                        .IsRequired()
                        .HasColumnType("varchar(4)");

                    b.Property<string>("UnidadeMedidaCapacidade")
                        .IsRequired()
                        .HasColumnType("varchar(4)");
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Base.Estados", b =>
                {
                    b.HasOne("Agrobook.Domain.Models.Base.Paises", "Pais")
                        .WithMany("Estados")
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Parceiro.Associados", b =>
                {
                    ...
                    b.HasOne("Agrobook.Domain.Models.Parceiro.PessoasFisicas", "PessoaFisica")
                        .WithOne("Associado")
                        .HasForeignKey("Agrobook.Domain.Models.Parceiro.Associados", "PessoaFisicaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Agrobook.Domain.Models.Parceiro.PessoasJuridicas", "PessoaJuridica")
                        .WithOne("Associado")
                        .HasForeignKey("Agrobook.Domain.Models.Parceiro.Associados", "PessoaJuridicaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
