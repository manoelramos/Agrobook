...
namespace Agrobook.Infra.Data.Migrations
{
    ...
    [Migration("20211016042556_Add_TablePedidos")]
    partial class Add_TablePedidos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Base.Moedas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Financiamentos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Parceiro.Parcelas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Pedido.Insumos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Pedido.Pedidos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("NumeroPedidoFornecedor")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Caixa.Despesas", b =>
                {
                    ...
                    b.HasOne("Agrobook.Domain.Models.Parceiro.Associados", "Credor")
                        .WithMany("Despesas")
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Financiamentos", b =>
                {
                    ...
                    b.HasOne("Agrobook.Domain.Models.Base.Moedas", "Moeda")
                        .WithMany("Financiamentos")
                        .HasForeignKey("IdMoedaParcela")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Parceiro.ComprovantesPagamentos", b =>
                {
                    b.HasOne("Agrobook.Domain.Models.Parceiro.Parcelas", "Parcelas")
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Parceiro.Parcelas", b =>
                {
                    ...
                    b.HasOne("Agrobook.Domain.Models.Financiamentos", "Financiamentos")
                        .WithMany("Parcelas")
                    ...
                    b.HasOne("Agrobook.Domain.Models.Pedido.Pedidos", "Pedido")
                        .WithMany("Parcelas")
            ...
            modelBuilder.Entity("Agrobook.Domain.Models.Pedido.Pedidos", b =>
                {
                    ...
                    b.HasOne("Agrobook.Domain.Models.Parceiro.Juridicas", "Fornecedor")
                        .WithMany("Pedidos")
                        .HasForeignKey("FornecedorId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Agrobook.Domain.Models.Pedido.Insumos", "Insumo")
                        .WithMany("Pedidos")
                        .HasForeignKey("InsumoId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Agrobook.Domain.Models.Base.UnidadesMedidas", "UnidadeMedida")
                        .WithMany("Pedidos")
