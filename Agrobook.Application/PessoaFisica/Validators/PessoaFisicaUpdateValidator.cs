namespace Agrobook.Application.PessoaFisica.Validators
{
    ...
    public class PessoaFisicaUpdateValidator : AbstractValidator<PessoaFisicaUpdateCommand>
    {
        public PessoaFisicaUpdateValidator()
        {
        ...
        {
            return new Contract<int>().IsCpf(cpf.ToString(), "CPF", "CPF inválido").IsValid;            
        }
    }
}
